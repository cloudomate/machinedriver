...
import (
	...
	_ "github.com/masteryodareturns/machinedriver/g42go/ecs"
	_ "github.com/masteryodareturns/machinedriver/g42go/ims"
	_ "github.com/masteryodareturns/machinedriver/g42go/vpc"

	"github.com/masteryodareturns/machinedriver/com/client"
	"github.com/masteryodareturns/machinedriver/com/modules"
	"github.com/masteryodareturns/machinedriver/com/modules/ecsModules"
	"github.com/masteryodareturns/machinedriver/com/modules/imsModules"
	"github.com/masteryodareturns/machinedriver/com/modules/novaModules"
	"github.com/masteryodareturns/machinedriver/com/modules/vpcModules"
...
func (d *Driver) GetCreateFlags() []mcnflag.Flag {
	return []mcnflag.Flag{
		...
		mcnflag.StringFlag{
			Name:   "g42-root-volume-type",
			Usage:  "Root Volume Type",
			Value:  "SATA",
			EnvVar: "ROOT_VOLUME_TYPE",
		},
		mcnflag.IntFlag{
			Name:   "g42-root-volume-size",
...
func (d *Driver) SetConfigFromFlags(flags drivers.DriverOptions) error {
	d.ServiceEndpoint = flags.String("g42-service-endpoint")
	d.SecurityGroupName = flags.String("g42-security-group")
	d.AccessKey = flags.String("g42-access-key-id")
	d.SecretKey = flags.String("g42-access-key-secret")
	d.ImageId = flags.String("g42-image-id")
	d.AvailableZone = flags.String("g42-available-zone")
	d.FlavorId = flags.String("g42-flavor-id")
	d.SubnetId = flags.String("g42-subnet-id")
	d.RootVolType = flags.String("g42-root-volume-type")
	d.RootVolSize = flags.Int("g42-root-volume-size")
	d.TenantId = flags.String("g42-tenant-id")
	d.Region = flags.String("g42-region")
	d.VpcId = flags.String("g42-vpc-id")
	d.AdminPass = flags.String("g42-admin-password")
	d.BandwidthSize = flags.Int("g42-bandwidth-size")
	d.BandwidthType = flags.String("g42-bandwidth-type")
	d.ElasticIpType = flags.String("g42-elasticip-type")
	d.SSHUser = flags.String("g42-ssh-user")
	d.ElasticIpBool = flags.Int("g42-elastic-ip")
...
func (d *Driver) checkConfig() error {
	if d.ServiceEndpoint == "" {
		return fmt.Errorf(errorMandatoryEnvOrOption, "Service Endpoint", "SERVICE_ENDPOINT", "--g42-service-endpoint")
	}
	if d.Region == "" {
		return fmt.Errorf(errorMandatoryEnvOrOption, "Region", "REGION", "g42-region")
	}
	if d.TenantId == "" {
		return fmt.Errorf(errorMandatoryEnvOrOption, "Tenant ID", "TENANT_ID", "--g42-tenant-id")
	}
...
func (d *Driver) getIPAddress() {
	...
	// ref: https://github.com/rancher/machine/blob/master/libmachine/drivers/base.go#L14-L17
	if d.ElasticIP != "" {
